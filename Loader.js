document.addEventListener("DOMContentLoaded", function () {
    const resources = [
      {
        type: "script",
        src: "https://cdn.jsdelivr.net/npm/nipplejs@0.10.2/dist/nipplejs.min.js",
        size: 38,
      },
      {
        type: "link",
      ...
      {
        type: "font",
        href: "https://fonts.gstatic.com/s/materialsymbolsoutlined/v195/kJF4BvYX7BgnkSrUwT8OhrdQw4oELdPIeeII9v6oDMzByHX9rA6RzazHD_dY40KH8nGzv3fz_VFU22ZZLsYEpzC_1hCs5Y0J1Llf.woff2",
        size: 762,
      },
      {
        type: "script",
        src: "https://cdn.jsdelivr.net/npm/phaser@3.80.1/dist/phaser.min.js",
        size: 252.5,
      },
    ];
    ...
    function loadResource(resource) {
      return new Promise((resolve, reject) => {
        ...
        element.onerror = (error) => {
          console.error(
            `Failed to load resource: ${resource.href || resource.src}`,
            error
          );
          title.innerHTML = `<span>GAME</span> <span>CRASHED</span>`;
